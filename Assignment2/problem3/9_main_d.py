...
CURRENT CONFIG: Part (d) — Audio + Image Augmentation
    - Speed up 3%          (speed_factor = 1.03)
    - Add audio noise      (noise_std = 0.005)
    - Horizontal squeeze   (squeeze_factor = 0.97)
    - Horizontal expand    (expand_factor  = 1.03)
    - Add image noise      (image_noise_std = 0.02)
...
# ─────────────────────────────────────────────
#  EXPERIMENT CONFIG  –  PART (d)
# ─────────────────────────────────────────────
VARIATION_NAME  = "part_d"
VARIATION_LABEL = "Part (d) — Audio + Image Augmentation"

AUDIO_AUGMENT = {
    "speed_factor": 1.03,   # speed up 3%
    "noise_std":    0.005,  # audio noise
}

IMAGE_AUGMENT = {
    "squeeze_factor":  0.97,   # squeeze horizontally
    "expand_factor":   1.03,   # expand horizontally
    "image_noise_std": 0.02,   # image noise
}
