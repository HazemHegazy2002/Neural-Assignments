...
CURRENT CONFIG: Part (b) — Audio Augmentation
    - Speed up 3%  (speed_factor = 1.03)
    - Light additive noise (noise_std = 0.005)
...
# ─────────────────────────────────────────────
VARIATION_NAME  = "part_b"
VARIATION_LABEL = "Part (b) — Audio Augmentation (speed +3% + noise)"
...
AUDIO_AUGMENT = {
    ...
    "noise_std":    0.005,  # light additive noise
}
IMAGE_AUGMENT = None
...
# AUDIO_AUGMENT   = {"speed_factor": 1.03, "noise_std": 0.005}
# IMAGE_AUGMENT   = {"squeeze_factor": 0.97, "expand_factor": 1.03, "image_noise_std": 0.02}
